...
QUnit.test("test value > 0", function(assert)
{
	assert.throws(function(assert) {var m1=new money(-2,"EUR");}, ValueInfZeroExc, "Valeur inférieur à 0");
	assert.throws(function(assert) {var m1=new money(-89.5,"EUR");}, ValueInfZeroExc, "Valeur inférieur à 0");
}
);

QUnit.test("test devise > 3 caractères", function(assert)
{
	assert.throws(function(assert) {var m1=new money(2,"EURS");}, DeviseSupTroisCarExc, "Devise supérieur à 3 caractères");
	assert.throws(function(assert) {var m1=new money(1050,"PESETAS");}, DeviseSupTroisCarExc, "Devise supérieur à 3 caractères");
}
);
