...
QUnit.test("test soustraction < 0", function(assert)
{
	...
	assert.throws(function(assert) {var m3=MoneyOps.sub(m1, m2);}, SoustractionInfZeroExc, "Soustraction inférieur à 0");
}
);
